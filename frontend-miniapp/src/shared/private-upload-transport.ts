...
export function createPrivateUploadTransport(origin: string, send: MultipartSender): PrivateUploadTransport {
  if (!/^https:\/\/[^/?#]+$/.test(origin)) throw new Error('HTTPS_ORIGIN_REQUIRED')
