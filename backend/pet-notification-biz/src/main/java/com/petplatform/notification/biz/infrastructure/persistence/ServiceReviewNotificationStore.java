...
import com.petplatform.notification.biz.infrastructure.persistence.mapper.NotificationServiceReviewMapper;
...
public final class ServiceReviewNotificationStore {
  private final SqlSessionTemplate sql;
  private final TransactionTemplate transaction;
  private final BiPredicate<String, DispatchedEvent> consumeGuard;

  public ServiceReviewNotificationStore(
    ...
    try {
      ...
      factory.setMapperLocations(
          new PathMatchingResourcePatternResolver()
              .getResources("classpath*:mapper/NotificationServiceReviewMapper.xml"));
