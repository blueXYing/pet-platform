...
经用户授权按序合并：PR38（15e1f64，前置切片）→ #39（ee4fd05）→ #40（d8b623c）→ #41（b6f6088）→ #42（809a443）→ #43（ba54ef5）→ #44（19b15d0），全部无冲突合入 develop；22号裁决完成回执已登记，PLAT-006 标记 DONE。生产启用、生产数据库迁移与 PLAT-002 门禁仍按原范围待后续授权。
