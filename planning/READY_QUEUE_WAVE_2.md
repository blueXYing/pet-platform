...
| MER-001 / Backend Core | PR50～57、60、59已合入；PR61～63交付手机签约页、准入两端点（CCR-W2-ADMISSION-001）与工作台真实准入，模拟器全链人工验收通过 | 通知读取/消息页/受控跳转（NTF-001+C-006，审批通知已落库待读）；成员/核销映射/在途守卫/冻结写动作及生产门禁；完整Issue仍IN_PROGRESS | MER001/ORD009/010；W2-MER-001～003 |
