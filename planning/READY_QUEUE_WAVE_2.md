...
| MER-001 / Backend Core | 2026-09-17已获用户推进授权，契约阶段IN_PROGRESS；[审阅包](ccr/CCR-W2-API-001/merchant-domain-proposal.md)已形成，未实现 | 审阅字段/接口/存储；确认协议换版和下线存量条款冲突后同步权威契约；成员绑定与员工在途检查按技术依赖继续交接 | MER001/ORD009/010；W2-MER-001～003 |
