...
| MER-001 / Backend Core | PR50/51已合入；S3协议四表、真实存储/同意/幂等组件通过289项全后端回归，见[交接](issues/wave-2/MER-001-s3/HANDOFF.md) | 新实现PR待审；[申请审核CCR](ccr/CCR-W2-API-001/merchant-application-review-proposal.md)四项新映射待确认，申请真实源/发布/HTTP/成员和在途守卫尚缺，不标完整MER完成 | MER001/ORD009/010；W2-MER-001～003 |
