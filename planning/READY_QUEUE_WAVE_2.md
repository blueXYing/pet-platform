...
| SVC-001 / Backend Core | 服务域CCR提案v0.2已推送待批（SVC-D1～D5，含依赖核验与消费者侧展示资格查询增补） | 待人工批准后：同步权威07/10/11/27→实现pet-service-*→W2-SVC-001～003测试→PR；不提前实现预约交易 | ORD008；W2-SVC-001～003 |
