...
| 商家/门店/人员 | MER-001 | C003/M002/ADM001 | 2026-09-17已启动契约阶段：[商家域提案](CCR-W2-API-001/merchant-domain-proposal.md)、存储映射、来源差异及22项验收设计已形成，REVIEW_REQUIRED；未同步权威Contract/未实现。OD-W0-002已解除，协议换版与下线存量条款冲突单独待确认 |
