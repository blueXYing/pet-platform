...
文档PR81首次CI在原有通知测试发生竞态：通知已写入而Outbox尚为PUBLISHING。根Work将最小等待修复交独立QA，原20秒/200ms界限不变，等待唯一通知和PUBLISHED都满足后再继续，原终态及权限反例保留；生产代码不变。QA定向测试1/1通过，独立提交4f9230e，本分支集成为f38cad8。该修复仅用于本轮可靠验证，G1/G2/G3未来业务测试仍NOT_EXECUTED。
