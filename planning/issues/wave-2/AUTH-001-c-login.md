...
> 2026-09-16 本轮C端接入候选已实施：微信认证/会话、昵称保存及宠物CRUD接到已批HTTP；预览与真实作用域独立。性别/签名、上传、芯片/医疗记录和正式环境门禁保留。下文为历史交付，不代表本轮仍未接接口；精确范围/验证与未执行项见[最新接入报告](../../progress/2026-09-16/C_REAL_API_INTEGRATION.md)。

> 2026-09-16 PR36后核查：PR31/33/36已合入develop b91a014。PR36历史回执记录真实微信code登录、手机号绑定、会话查询、带会话宠物查询及登出成功，修复了凭据文件打包排除和模板YAML；本轮未重跑真实微信。页面仍为预览，宿主退出证明及正式环境门禁未解除，完整AUTH-001非DONE、CCR-ACR-001非RESOLVED。见[整合收尾报告](../../progress/2026-09-16/ID_INTEGRATION_CLOSEOUT.md)。下文是首阶段范围快照，不能把其中“真实Provider未授权”或旧基线视为当前状态。
